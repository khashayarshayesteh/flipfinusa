...
const Home = () => {
  return (
    <>
        ...
        <div className="relative mx-auto grid w-full max-w-7xl items-center gap-14 lg:grid-cols-2">
          <div className="relative z-10">
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-600">
              ...
              favorite waterway, our foldable fin makes it easier than ever.
              No more struggling with bulky fins or worrying about limited
              storage space.
            </p>
      ...
      <section
        id="features"
        className="scroll-mt-28 bg-white px-6 py-24 lg:px-8"
      >
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-4xl font-bold tracking-tight text-slate-950 sm:text-5xl">
              Easy to store. Easy to set up. Built to perform.
            </h2>
          </div>

          <div className="mt-16 grid gap-8 md:grid-cols-3">
            <article className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">
              More convenient transportation for every adventure
            </h2>
            ...
            <div className="mt-8 space-y-4">
              {[
                "Sleek, low-profile storage",
                "Fast push or pull operation",
                "Reliable stability and control",
                "Less hassle during travel and transport",
              ].map((item) => (
          ...
          <div className="overflow-hidden rounded-3xl shadow-2xl">
            <img
              src={productImage1}
              alt="Flip Fin mounted on a paddle board"
      ...
      <section className="bg-slate-100 px-6 py-24 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-lg leading-8 text-slate-600">
            ...
            fins, making it a versatile choice for your paddleboarding needs.
          </p>

          <p className="mx-auto mt-4 max-w-3xl text-lg leading-8 text-slate-600">
            No complicated steps—just unfold the fin, follow the instructions,
            and you’re ready to hit the water!
          </p>
